...
✧ᴛʜᴇꜱᴇ ᴍᴏᴅᴜʟᴇꜱ ʙʏ ➪ [sᴄᴏᴜᴛ 𓃵](https://t.me/Fake_Scout)"""
...
- /ban: Bᴀɴ ᴀ ᴜsᴇʀ.
- /dban: Bᴀɴ ᴀ ᴜsᴇʀ ʙʏ ʀᴇᴘʟʏ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ᴛʜᴇɪʀ ᴍᴇssᴀɢᴇ.
- /sban: Sɪʟᴇɴᴛʟʏ ʙᴀɴ ᴀ ᴜsᴇʀ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ.
- /tban: Tᴇᴍᴘᴏʀᴀʀɪʟʏ ʙᴀɴ ᴀ ᴜsᴇʀ. Exᴀᴍᴘʟᴇ ᴛɪᴍᴇ ᴠᴀʟᴜᴇs: 𝟺ᴍ = 𝟺 ᴍɪɴᴜᴛᴇs, 𝟹ʜ = 𝟹 ʜᴏᴜʀs, 𝟼ᴅ = 𝟼 ᴅᴀʏs, 𝟻ᴡ = 𝟻 ᴡᴇᴇᴋs.
- /unban: Uɴʙᴀɴ ᴀ ᴜsᴇʀ.
- /mute: Mᴜᴛᴇ ᴀ ᴜsᴇʀ.
- /dmute: Mᴜᴛᴇ ᴀ ᴜsᴇʀ ʙʏ ʀᴇᴘʟʏ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ᴛʜᴇɪʀ ᴍᴇssᴀɢᴇ.
- /smute: Sɪʟᴇɴᴛʟʏ ᴍᴜᴛᴇ ᴀ ᴜsᴇʀ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ.
- /tmute: Tᴇᴍᴘᴏʀᴀʀɪʟʏ ᴍᴜᴛᴇ ᴀ ᴜsᴇʀ. Exᴀᴍᴘʟᴇ ᴛɪᴍᴇ ᴠᴀʟᴜᴇs: 𝟺ᴍ = 𝟺 ᴍɪɴᴜᴛᴇs, 𝟹ʜ = 𝟹 ʜᴏᴜʀs, 𝟼ᴅ = 𝟼 ᴅᴀʏs, 𝟻ᴡ = 𝟻 ᴡᴇᴇᴋs.
- /unmute: Uɴᴍᴜᴛᴇ ᴀ ᴜsᴇʀ.
- /kick: Kɪᴄᴋ ᴀ ᴜsᴇʀ.
- /dkick: Kɪᴄᴋ ᴀ ᴜsᴇʀ ʙʏ ʀᴇᴘʟʏ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ᴛʜᴇɪʀ ᴍᴇssᴀɢᴇ.
- /skick: Sɪʟᴇɴᴛʟʏ ᴋɪᴄᴋ ᴀ ᴜsᴇʀ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ.
- /kickme: Usᴇʀs ᴛʜᴀᴛ ᴜsᴇ ᴛʜɪs, ᴋɪᴄᴋ ᴛʜᴇᴍsᴇʟᴠᴇs.
