...
BOT_USERNAME = getenv("BOT_USERNAME", "TSERIESSMUSICBOT")
BOT_NAME = getenv("BOT_NAME", "─˹ᴛ-sᴇʀɪᴇs ꭙ ᴍᴜsɪᴄ˼─")
ASSUSERNAME = getenv("ASSUSERNAME", "musicxkrishan")
EVALOP = list(map(int, getenv("EVALOP", "6797202080").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002326978287))
...
PLAYLIST_IMG_URL = "https://envs.sh/vPt.jpg"
STATS_IMG_URL = "https://envs.sh/vPt.jpg"
TELEGRAM_AUDIO_URL = "https://envs.sh/vPt.jpg"
TELEGRAM_VIDEO_URL = "https://envs.sh/vPt.jpg"
STREAM_IMG_URL = "https://envs.sh/vPt.jpg"
SOUNCLOUD_IMG_URL = "https://envs.sh/vPt.jpg"
YOUTUBE_IMG_URL = "https://envs.sh/vPt.jpg"
SPOTIFY_ARTIST_IMG_URL = "https://envs.sh/vPt.jpg"
SPOTIFY_ALBUM_IMG_URL = "https://envs.sh/vPt.jpg"
SPOTIFY_PLAYLIST_IMG_URL = "https://envs.sh/vPt.jpg"
